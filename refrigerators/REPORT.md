...
Modern refrigerators show a mean 42 kWh/yr lower and a median
...
presence of compact ≈5 ft³ units and full-size ≈20 ft³ units.
...
### 3.3 Historical perspective (AHAM(4) / DOE)
...
### 4.1 Capacity × Energy broken down by Type
...
Each additional cubic foot of cabinet costs ~16.8 kWh/yr.
...
(modern fridges include more units in the 200-300 kWh/yr range). The monotone decline in the yearly mean (Fig. 4) even within the 12-year window covered by the individual data confirms a continuous efficiency gain.
...
4. AHAM — Home Appliance Industry Fact Sheets.
   https://www.aham.org